...
def quiz_one1(index_n,quiz_list,answer): 
    ...
    #st.write(st.session_state["answer_n"])

    for index,i in enumerate(quiz_list):
        st.write(f'{index+1}.{i}')

    if val1 := int(st.number_input('정답 번호를 입력하세요.')):
...
def quiz_one2(index_n,quiz_list,answer): 
    ...
    if val2 := int(st.number_input('정답 번호를 입력하세요.')):
...
def quiz_one3(index_n,quiz_list,answer): 
    ...
    if val3 := int(st.number_input('정답 번호를 입력하세요.')):
...
def quiz_one4(index_n,quiz_list,answer): 
    ...
    if val4 := int(st.number_input('정답 번호를 입력하세요.')):
...
def quiz_one5(index_n,quiz_list,answer): 
    ...
    if val5 := int(st.number_input('정답 번호를 입력하세요.')):
...
def quiz_one6(index_n,quiz_list,answer): 
    ...
    if val6 := int(st.number_input('정답 번호를 입력하세요.')):
...
def quiz_one7(index_n,quiz_list,answer): 
    ...
    if val7 := int(st.number_input('정답 번호를 입력하세요.')):
...
def quiz_one8(index_n,quiz_list,answer): 
    ...
    if val8 := int(st.number_input('정답 번호를 입력하세요.')):
...
def quiz_one9(index_n,quiz_list,answer): 
    ...
    if val9 := int(st.number_input('정답 번호를 입력하세요.')):
...
def quiz_one10(index_n,quiz_list,answer): 
    ...
    if val10 := int(st.number_input('정답 번호를 입력하세요.')):
    ...
    #try:
    #    
    #    answer_tmp = quiz_list[st.session_state["answer"]-1]
    #except:
        ...
        for x,y in zip(answer_list,wrong_list):
            ...
            with placeholder.container():
                ...
                if st.session_state['stage'] == 1:
                    placeholder.empty()
                    with placeholder.container():
                        quiz_one1(st.session_state["stage"],list_f[0],answer_list2[0])
                elif st.session_state['stage'] == 2:
                    placeholder.empty()
                    with placeholder.container():
                        quiz_one2(st.session_state["stage"],list_f[1],answer_list2[1])
                elif st.session_state['stage'] == 3:
                    placeholder.empty()
                    with placeholder.container():
                        quiz_one3(st.session_state["stage"],list_f[2],answer_list2[2])
                elif st.session_state['stage'] == 4:
                    placeholder.empty()
                    with placeholder.container():
                        quiz_one4(st.session_state["stage"],list_f[3],answer_list2[3])        
                elif st.session_state['stage'] == 5:
                    placeholder.empty()
                    with placeholder.container():
                        quiz_one5(st.session_state["stage"],list_f[4],answer_list2[4])
                elif st.session_state['stage'] == 6:
                    placeholder.empty()
                    with placeholder.container():
                        quiz_one6(st.session_state["stage"],list_f[5],answer_list2[5])
                elif st.session_state['stage'] == 7:
                    placeholder.empty()
                    with placeholder.container():
                        quiz_one7(st.session_state["stage"],list_f[6],answer_list2[6])
                elif st.session_state['stage'] == 8:
                    placeholder.empty()
                    with placeholder.container():
                        quiz_one8(st.session_state["stage"],list_f[7],answer_list2[7])
                elif st.session_state['stage'] == 9:
                    placeholder.empty()
                    with placeholder.container():
                        quiz_one9(st.session_state["stage"],list_f[8],answer_list2[8])
                elif st.session_state['stage'] == 10:
                    placeholder.empty()
                    with placeholder.container():
                        quiz_one10(st.session_state["stage"],list_f[9],answer_list2[9])
                else:
                    placeholder.empty()
                    with placeholder.container():
